...
HB_FUNC( XPAINTBARRAH )
{
	static const HB_BYTE pcode[] =
	{
		...
		7,36,61,0,176,18,0,95,7,122,92,18,92,95,
		92,10,92,5,92,5,93,178,0,93,178,0,93,178,
		0,4,3,0,93,178,0,93,178,0,93,178,0,4,
		3,0,121,20,10,36,64,0,176,19,0,95,5,20,
		1,36,65,0,176,19,0,95,6,20,1,36,66,0,
		176,20,0,95,2,20,1,36,69,0,7
	};
...
HB_FUNC( XGETBARNAME )
{
	static const HB_BYTE pcode[] =
	{
		116,23,0,36,74,0,103,1,0,110,7
	};
